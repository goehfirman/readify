        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-8 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 md:gap-4 lg:gap-6">
             ...
             <div className="hidden md:flex items-center gap-2">
                ...
                <Link href="/explore/diagnostic" className="px-5 py-2 rounded-3xl bg-white text-[#A0AEC0] border-4 border-transparent hover:border-[#E2E8F0] hover:bg-[#F8FAFC] flex items-center gap-2 font-bold text-xs uppercase tracking-wide transition-all group">
                  <span className="material-symbols-rounded text-lg group-hover:text-[#FFB347]">stairs</span>
